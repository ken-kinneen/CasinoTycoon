...
// Machine shop — repeatable purchases, available at any casino anytime.
// `baseCost` is the price of the first one; each additional costs more via scaling.
export const MACHINE_SHOP = [
  { id: 'machine', name: 'Slot Machine', baseCost: 150, costScale: 1.35, model: 'machines', blurb: 'One-armed bandit. Guests play on their own — passive income.', playstyle: 'PASSIVE', playstyleClass: 'ps-passive' },
  { id: 'blackjack', name: 'Blackjack Table', baseCost: 300, costScale: 1.4, model: 'blackjacktables', blurb: 'Deal the cards yourself. More payout per guest, more work for you.', playstyle: 'HANDS-ON', playstyleClass: 'ps-active' },
  { id: 'roulette', name: 'Roulette Table', baseCost: 300, costScale: 1.4, model: 'roulettetables', blurb: 'Spin the wheel, work the margins. The wheel is warped. That\'s a feature.', playstyle: 'HANDS-ON', playstyleClass: 'ps-active' },
];

// Casino-specific upgrades — one-time purchases that modify stats.
// Machine/table spawns removed — those are now in MACHINE_SHOP.
export const CASINO_UPGRADES = {
  duck: [
    ...
    { id: 'd_hoppers', name: 'Reinforced Cash Drawers', cost: 4000, blurb: 'Sturdier drawers. Harder to crack, easier to fill.', model: 'hopper', group: 'operations', effects: [{ stat: 'houseEdge', mul: 1.1 }] },
    ...
    { id: 'd_cart', name: 'Armored Cart Service', cost: 8000, blurb: 'A guy with a cart moves cash around. Great guy. Owes me.', model: 'cart', group: 'operations', effects: [{ stat: 'spendPerMin', mul: 1.1 }] },
  ],
  rat: [
    ...
    { id: 'r_vault', name: 'Vault Upgrade', cost: 35000, blurb: 'A bigger vault. Money flows downhill, straight to me.', model: 'vault', group: 'operations', effects: [{ stat: 'houseEdge', mul: 1.15 }, { stat: 'spendPerMin', mul: 1.1 }] },
  ...
  diablo: [
    ...
    { id: 'p_rail', name: 'Underground Vault Rail', cost: 550000, blurb: 'A little train that carries money to me. I named it.', model: 'traincart', group: 'operations', effects: [{ stat: 'houseEdge', mul: 1.15 }, { stat: 'spendPerMin', mul: 1.15 }] },
