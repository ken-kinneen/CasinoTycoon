...
export const CASINO_UPGRADES = {
  duck: [
    ...
    { id: 'd_tighten', name: 'Tighten the Slots', cost: 1200, blurb: 'The payout chip is now a drawing of a payout chip.', model: 'slotwrench', effects: [{ stat: 'houseEdge', mul: 1.2 }, { stat: 'heat', add: 4 }] },
    { id: 'd_peanuts', name: 'Free Peanuts (Extra Salty)', cost: 1500, blurb: 'Thirsty people buy drinks. Drunk people buy spins.', model: 'peanuts', effects: [{ stat: 'spendPerMin', mul: 1.1 }] },
    ...
    { id: 'd_marshal', name: 'Bribe the Fire Marshal', cost: 2500, blurb: 'Max occupancy is now whatever I write on the sign.', model: 'badge', effects: [{ stat: 'trafficPerMin', add: 0.8 }, { stat: 'heat', add: -5 }] },
    ...
    { id: 'd_hoppers', name: 'Bigger Cash Hoppers', cost: 4000, blurb: 'Fewer trips to the safe. More time for evil.', model: 'hopper', effects: [{ stat: 'hopperCap', mul: 2 }] },
  ...
  rat: [
    ...
    { id: 'r_commission', name: 'Bribe the Gaming Commission', cost: 15000, blurb: 'Their audit found nothing. I found their price.', model: 'badge', effects: [{ stat: 'heat', add: -12 }] },
    ...
    { id: 'r_rooms', name: '"Complimentary" Hotel Rooms', cost: 25000, blurb: 'The doors lock from the outside. For their safety.', model: 'hotelkey', effects: [{ stat: 'stayTime', mul: 1.25 }, { stat: 'heat', add: 6 }] },
    ...
    { id: 'r_vault', name: 'Vault Upgrade', cost: 35000, blurb: 'Bigger hoppers, a chute to the vault. Money flows downhill.', model: 'vault', effects: [{ stat: 'hopperCap', mul: 2 }, { stat: 'autoCollect', add: 0.1 }] },
    ...
    { id: 'r_mayor', name: 'Mayor on the Payroll', cost: 90000, blurb: 'He cut the ribbon. He also cut the zoning laws.', model: 'badge', effects: [{ stat: 'heat', add: -20 }, { stat: 'stayTime', mul: 1.15 }] },
  ],
  diablo: [
    ...
    { id: 'p_sportsbook', name: 'Wire the Sportsbook', cost: 220000, blurb: 'I know the score before the game. Sometimes before the season.', model: 'sportsbook', effects: [{ stat: 'houseEdge', mul: 1.2 }, { stat: 'heat', add: 8 }] },
    { id: 'p_tables', name: 'Two High-Roller Tables', cost: 250000, blurb: 'Minimum bet: your house.', model: 'tables', effects: [{ stat: 'tables', add: 2 }] },
    { id: 'p_senator', name: 'Senator on Retainer', cost: 300000, blurb: 'He filibustered a bill about me. For eleven hours. Bless him.', model: 'badge', effects: [{ stat: 'heat', add: -25 }] },
    ...
    { id: 'p_chimes', name: 'Hypnotic Slot Chimes', cost: 400000, blurb: 'Tuned to the exact frequency of "just one more".', model: 'radio', effects: [{ stat: 'spendPerMin', mul: 1.2 }] },
    ...
    { id: 'p_rail', name: 'Underground Vault Rail', cost: 550000, blurb: 'A little train that carries money to me. I named it.', model: 'traincart', effects: [{ stat: 'autoCollect', add: 0.2 }, { stat: 'hopperCap', mul: 2 }] },
    { id: 'p_chips', name: 'Chips That Look Bigger Than They Are', cost: 600000, blurb: 'A $5 chip the size of a dinner plate. Feels like nothing to lose.', model: 'bigchip', effects: [{ stat: 'spendPerMin', mul: 1.15 }, { stat: 'sharpness', add: -0.05 }] },
    { id: 'p_exits', name: '"Lost" Exit Signs', cost: 650000, blurb: 'The fire code says exits must be marked. It doesn\'t say correctly.', model: 'exitsign', effects: [{ stat: 'stayTime', mul: 1.15 }, { stat: 'heat', add: 10 }] },
    ...
    { id: 'p_governor', name: 'Own the Governor', cost: 1200000, blurb: 'Not bribe. Own. There\'s a receipt.', model: 'badge', effects: [{ stat: 'heat', add: -40 }, { stat: 'houseEdge', mul: 1.1 }] },
  ],
};
